...
func (m *MockDataStore) EnvPath(env Persistence) string {
	args := m.Called(env)
	return args.String(0)
}

func (m *MockDataStore) ConfigPath(env Persistence) string {
	args := m.Called(env)
	return args.String(0)
}
...
func (m *MockDataStore) Reload(ctx context.Context, env Persistence) error {
	args := m.Called(ctx, env)
	return args.Error(0)
}

func (m *MockDataStore) Save(ctx context.Context, env Persistence, options *SaveOptions) error {
