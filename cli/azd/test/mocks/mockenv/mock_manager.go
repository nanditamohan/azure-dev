...
func (m *MockEnvManager) Save(ctx context.Context, env environment.Persistence) error {
...
func (m *MockEnvManager) Reload(ctx context.Context, env environment.Persistence) error {
	args := m.Called(ctx, env)
	return args.Error(0)
}

func (m *MockEnvManager) EnvPath(env environment.Persistence) string {
	args := m.Called(env)
	return args.String(0)
}

func (m *MockEnvManager) ConfigPath(env environment.Persistence) string {
	args := m.Called(env)
	return args.String(0)
}
